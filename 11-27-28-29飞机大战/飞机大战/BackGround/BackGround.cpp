...
void CBackGround::ShowBackGround(HDC hdc, HDC compHdc){
	...
	::BitBlt(hdc,m_nx,m_ny,MAPSIZE_BACKGROUND_WIDTH,MAPSIZE_BACKGROUND_HEIGH,compHdc,0,0,SRCCOPY);

	::SelectObject(compHdc,m_backDown);
	::BitBlt(hdc,m_nx,m_ny-MAPSIZE_BACKGROUND_HEIGH,MAPSIZE_BACKGROUND_WIDTH,MAPSIZE_BACKGROUND_HEIGH,compHdc,0,0,SRCCOPY);
}
